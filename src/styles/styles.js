const styles = {
    ...
    heading: 'text-[24px] text-center md:text-start font-[600] font-Roboto pb-[20px]',
    ...
    price:"font-[500] text-[14px] text-[#d55b45] line-through",
    shop_name:"text-[12px] text-blue-400 pb-1",
